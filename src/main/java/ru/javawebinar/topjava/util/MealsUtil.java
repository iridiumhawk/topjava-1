...
public class MealsUtil {
    ...
    private static final List<Meal> meals = Arrays.asList(
            ...
            new Meal(LocalDateTime.of(2015, Month.MAY, 31, 14, 0), "Обед2", 300),
            new Meal(LocalDateTime.of(2015, Month.MAY, 31, 20, 0), "Ужин", 510),
            new Meal(LocalDateTime.of(2015, Month.MAY, 31, 21, 0), "Ужин2", 300),
            new Meal(LocalDateTime.of(2015, Month.MAY, 31, 23, 0), "Полночник", 510)
    );
